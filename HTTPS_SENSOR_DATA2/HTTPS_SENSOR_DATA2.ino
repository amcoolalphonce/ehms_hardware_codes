...
const char* ssid = "kintoon";
const char* password = "Kintoon202six";


const char* server = "http://192.168.0.16:8000";  // Use local network IP 
const char* endpoint = "/health-data/";


const int user_id = 1; // Replace with actual user ID 
...
void loop() {
  if (WiFi.status() == WL_CONNECTED) {
    ...
    // function to read data from sensors here
